...
class TestSafeDescale(unittest.TestCase):
    def test_cont_design_space(self):
        ...
        class DummyProblemX:
            def __init__(self):
                self.design_space = ds.DesignSpace([ds.FloatVariable(0, 1)])

        class DummyState:
            def __init__(self):
                self.x_factor = (np.array([1]),)
                self.x_step = (np.array([0]),)
                self.problem = DummyProblemX()
        ...
        class DummyProblemY:
            def __init__(self):
                self.design_space = ds.DesignSpace(
                    [ds.FloatVariable(-5, 5), ds.FloatVariable(-5, 5)]
                )
    ...
    def test_mix_design_space(self):
        ...
        class DummyProblemZ:
            def __init__(self):
                self.design_space = ds.DesignSpace([ds.CategoricalVariable([0, 1, 2])])

        class DummyState:
            def __init__(self):
                self.x_factor = (np.array([1]),)
                self.x_step = (np.array([0]),)
                self.problem = DummyProblemZ()
